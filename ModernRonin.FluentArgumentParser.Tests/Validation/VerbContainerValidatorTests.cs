...
namespace ModernRonin.FluentArgumentParser.Tests.Validation
{
    ...
    public class VerbContainerValidatorTests
    {
        ...
        {
            var grandparent = new Verb("grandpa") {new Verb("daddy") {new Verb()}};
        ...
        {
            var parent = new Verb("parent") {new Verb {Name = null}};
        ...
        public void Fails_with_multiple_children_with_duplicate_names()
        {
            ...
            {
                new Verb {Name = "child1"},
                new Verb {Name = "child2"},
                new Verb {Name = "child1"}
            };
        ...
        {
            var grandparent = new Verb("grandpa") {new Verb("daddy") {new Verb("kiddo")}};
        ...
        {
            var parent = new Verb("parent") {new Verb {Name = "child"}};
