...
public class LeafVerbBindingTests
{
    ...
    {
        var action = () => _underTest.Fill(new SimpleTarget(), new VerbCall());
    ...
    {
        var action = () => _underTest.Fill(new SimpleTarget(), new VerbCall { Verb = _underTest.Verb });
